...
4. **Settings Menu**: [`SettingsFragment`](app/src/main/java/com/dannylumen/choozi/ui/settings/SettingsFragment.kt) dynamically reads all registered themes from [`ThemeManager.getAvailableThemes()`](app/src/main/java/com/dannylumen/choozi/theme/ThemeManager.kt), so any newly added theme automatically appears in the dropdown without XML changes.
...
Open [`ThemeManager.kt`](app/src/main/java/com/dannylumen/choozi/theme/ThemeManager.kt) and call `registerTheme(...)`:
